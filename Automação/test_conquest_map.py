...
def test_conquest_analysis(mundo="br140"):
    ...
    # Aplicar Blur e ajustar opacidade final para cores mais vivas
    ...
    draw.text((leg_x, 70), "Dinâmica de Noblagens (24h)", fill=(0,0,0), font=get_font(20, True))
    draw.text((leg_x, 100), "TOP 15 Tribos (Rank por Pontos)", fill=(80,80,80), font=get_font(15))
